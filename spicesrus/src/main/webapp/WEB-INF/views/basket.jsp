                      ...
                      <div class="item">
                        ...
                        <div style="display: flex;justify-content: center;flex-direction: column;margin-right: 100px;">
                          ...
                          <div class="itemquantity">
                            ...
                            <input type="hidden" value="${item.getProduct_id()}" path="id" name="id">
                            <input id="quantity" type="number" value="${item.quantity}" min="50" path="quantity"
                              name="quantity"></input>
                            <button class="basketplusbtn" id="increment" type="button">+</button>
                          </div>
                        </div>
                        <div style="display: flex;flex-direction: column;justify-content: space-evenly;">
                          <a href="/deleteitem?id=${item.getProduct_id()}"><img class="delete"
                              src="<c:url value='/media/delete.svg'/>"></a>
                        </div>
                      </div>
                    </c:forEach>
                  </c:forEach>
