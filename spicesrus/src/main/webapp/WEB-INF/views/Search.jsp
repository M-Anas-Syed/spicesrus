...
<header>
  <nav>
	...
	<S class="bar">
    	<form action="Search.jsp">
       		<input type="text" placeholder="Put text..." name="CORP_NAME" id="CORP_NAME" "/>
       		<button type="submit" onclick="Search.jsp"></button>
       	</form>
     </S>
...
<section>
  ...
  <div class="recipes">
    <div class="sortsection">
	  ...
	  <a % String CORP_NAME = newString(request.get.Parameter("CORP_NAME)); String sql = "select*from recipes where CORP_NAME like '%'+CORP_NAME+"%";%>
  </div>
